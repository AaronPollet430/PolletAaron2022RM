...
\PaperTitle{Onderzoek naar Next.js framework in vergelijking met React Native voor web ontwikkeling}
...
\Authors{Aaron Pollet\textsuperscript{1}} % Authors
...
\affiliation{
  \textsuperscript{1} \href{mailto:aaron.pollet@student.hogent.be}{aaron.pollet@student.hogent.be}}
